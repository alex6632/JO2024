...
class VilleController extends Controller
{
    ...
    /**
     * @Route("/{_locale}/villes/{id}", name="villes_show")
     * @Template()
     */
    public function getVille(Request $request, $id) {
        ...
        return $this->render('AlexBundle:Ville:showVille.html.twig', array(
            'ville' => $ville,
    ...
    public function editVilleAction(Request $request, $id) {
        ...
        if($request->isXmlHttpRequest()) {
            ...
            if(empty($form['nom'])) {
                ...
                $msg = array(
                    'type'       => 'success',
                    'msg'        => $this->get('translator')->trans('ville.updatedSuccess'),
                    'nom'        => $form['nom'],
                    'idVille'    => $ville->getId()
                );
            }
